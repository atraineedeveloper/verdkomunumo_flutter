                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          subtitle: const Text(
                            'Elektu luman, malluman au sisteman etoson',
                          ),
                        ),
                        Padding(
...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      await ref.read(settingsControllerProvider.notifier).saveProfile(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Profilo gxisdatigita!'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Ne eblis konservi la profilon.'),
          backgroundColor: Colors.redAccent,
        ),
      );
    }
